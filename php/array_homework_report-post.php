...
<body>
    ...
    <form action="./array_homework_report.php" metdod="POST">
...
<!-- 
        ...
        <p>
            ...
            <input type="text" name="productlist_number" id="productlist_number" placeholder="請輸入商品名稱">
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="product_in_quantity" id="product_in_quantity" placeholder="請輸入進貨數量">
        </p>
        <p>
        ...
        <p>
            ...
            <input type="datetime" name="product_in_time" id="product_in_time">
        </p>
        <p>
